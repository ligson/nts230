...
<div class="x_daohang">
    <p style="font-size:12px">当前位置：<a href="${createLink(controller: 'news', action: 'list')}">应用管理</a>>><a
            href="${createLink(controller: 'courseBcast', action: 'courseMgr')}">广播直播</a>>>节目预告</p>
</div>
...
<div class="body">
    ...
    <g:form name="form1" method="post">
            ...
            <table align="center">
                ...
                <tr class="prop">
                    <td valign="top" class="name">
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label for="dvbTitle"><g:message
                            code="dvbforeNotice.dvbTitle.label" default="信息标题"/></label>
                    </td>
                ...
                <tr class="prop">
                    <td valign="top" class="name">
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <label for="channel"><g:message
                            code="dvbforeNotice.channel.label" default="播出频道"/></label>
                    </td>
                    <td valign="top" class="value ${hasErrors(bean: dvbforeNotice, field: 'channel', 'errors')}">
                        <g:select name="channel.id" from="${Channel.list()}" optionKey="id" optionValue="channelName"
                                  value="${dvbforeNotice?.channel?.id}"/>
                    </td>
                </tr>
                <tr class="prop">
                    <td valign="top" class="name">
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label for="datePlayed"><g:message
                            code="dvbforeNotice.datePlayed.label" default="开播时间"/></label>
                    </td>
                    <td valign="top" class="value ${hasErrors(bean: dvbforeNotice, field: 'datePlayed', 'errors')}">
                        <g:mydatePicker name="datePlayed" maxlength="40" precision="minute"
                                        value="${dvbforeNotice?.datePlayed}"/>
                    </td>
                </tr>
                ...
                <tr class="prop">
                    <td valign="top" class="name">
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <label for="descriptions"><g:message
                            code="dvbforeNotice.descriptions.label" default="内容介绍"/></label>
                    </td>
                    <td valign="top" class="value ${hasErrors(bean: dvbforeNotice, field: 'descriptions', 'errors')}">
                        <g:textArea name="descriptions" style="width:400px" maxlength="2000" cols="40" rows="5"
                                    value="${dvbforeNotice?.descriptions}"/>
                    </td>
                </tr>
        ...
        <div class="buttons">
            <span class="button">
                <g:hiddenField name="id" value="${dvbforeNotice?.id}"/>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
