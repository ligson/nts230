...
<head>
    ...
    <script type=text/javascript>
        ...
        function showToLower(obj) {
            var request_url = baseUrl + "appMgr/queryCategoryTwo"; // 需要获取内容的url
        ...
        function updateUserActivity() {
            ...
            if ($("#name").val().trim().length == 0) {
                ...
                $("#descriptionPrompt").html("&nbsp;<font style='color:red;'>内容不能为空值</font>");
                $("#description").focus();
                $("#description").select();
                return false;
            }
            updateUserActivityForm.action = baseUrl + "appMgr/updateUserActivity";
    ...
    <div class="commend mt1">
        ...
        <DIV id=con>
            <dl class="tbox light2">
                <dt class="light"><strong class="icos3" style="padding-left:10px ">编辑活动</strong></dt>
            </dl>
            ...
            <DIV id=tagContent>
                ...
                <DIV class="tagContent selectTag" id=tagContent0>
                    <form action="update" method="post" enctype="multipart/form-data" name="updateUserActivityForm"
                        ...
                        <table class="edit_active_inp" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td width="10%">*活动标题</td>
                                <td width="90%">
                            ...
                            <tr>
                                ...
                                <td>
                                    <textarea name="description" id="description" cols="80"
                                              rows="10">${userActivity.description}</textarea>
                                    <span id="descriptionPrompt"></span></td>
                            </tr>
                            <tr>
                                <td>&nbsp;</td>
                                <td>
                                    <input type="button" style="padding: 3px" onclick="updateUserActivity()" name="button" class="subbtn"
                                           id="button" value="保存"/>
                                    <input type="button" style="padding: 3px" onclick="window.close();" class="subbtn" id="button2" value="关闭"/>
                                </td>
                            </tr>
                        </table>
                    </form>
