...
<head>
    ...
    <script language="javaScript">
        ...
        function addNews()
        {
            ...
            createForm.action="saveFriendLink";
            createForm.submit();
        }
        function backList()
        {
...
<form  method="post"  name="createForm">
    ...
    <div class="x_daohang">
        <span class="dangqian">当前位置：</span><a href="${createLink(controller: 'news', action: 'list')}">应用管理</a> >> <a href="${createLink(controller: 'news', action: 'list')}">外部资源</a> >> 添加
    </div
            ...
            <td width="2%">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr align="left" valign="top" >
                        ...
                        <td > <input  type="text" maxLength="40" name="name" id="name" size="20" /></td>
                        <td width="3%">&nbsp;</td>
                        <td width="16%">&nbsp;</td>
                        <td width="8%">&nbsp;</td>
                    </tr>
                    <tr align="left" valign="top" >
                        ...
                        <td> <input  type="text" maxLength="250" name="url" id="url" size="60" value="http://" />(请以http://开头)</td>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
                    </tr>
                    ...
                    <tr align="left" valign="top">
                        ...
                        <td colspan="5" valign="middle" align="center">
                            <a href="#dwd" ><input type="button" value="添加" class="subbtn" onClick="addNews();return false;" /></a>
                            <a href="#sd" ><input type="button" value="返回" class="subbtn" onClick="backList();return false;" /></a></td>
