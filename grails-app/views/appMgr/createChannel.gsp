    ...
    <g:form name="form1" method="post">
            ...
            <table align="center">
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value ${hasErrors(bean: channel, field: 'channelName', 'errors')}">
                        <g:textField name="channelName" maxlength="40" size="88" value="${channel?.channelName}"/>
                    </td>
                </tr>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" colspan="3"
                        ...
                        <g:textArea name="channelDesc" style="width:400px" size="120" maxlength="2000" cols="40"
        ...
        <div class="buttons">
            <span class="button">
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <img src="${resource(dir: 'images/skin', file: 'queding.gif')}" border="0" style="cursor:pointer;" onclick="check();">
            </span>
            <span class="button">
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
