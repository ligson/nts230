    ...
    <body>
	      ...
	      <div class="body">
            ...
            <g:form name="form1"  method="post" >
			     ...
			     <tr class="prop">
				  ...
				  <div style="height:18px;padding:5px;">
					 ...
					 ：<g:textField name="askServerTeacher" maxlength="100" value="${courseBcast?.askServerTeacher}" />
                           ...
                           <tr class="prop">
			         <td valign="top" class="name"  >
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label for="dateCreated">开始时间</label>
				 </td>
                                 <td valign="top" class="name"  >
                                     <g:mydatePicker name="datePlayed" maxlength="40" precision="minute" value="${courseBcast?.datePlayed}"  />
			    ...
			    <tr class="prop">
                            ...
                            <tr  class="prop">
                                ...
                                <td colspan="3" valign="top"  class="value ${hasErrors(bean: courseBcast, field: 'notes', 'errors')}">
                                    <g:textArea name="notes" size="70" style="width:450px" maxlength="800" cols="40" rows="5" value="${courseBcast?.notes}" />
                                </td>
		     ...
		     <div class="buttons">
		     <span class="button">
		     <g:hiddenField name="id" value="${courseBcast?.id}" />
		     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
