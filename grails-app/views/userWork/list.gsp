...
<head>
    ...
    <script type="text/javascript">
        ...
        function setParams() {
            ...
            document.userWorkForm.state.value = "${params.state}";
        }
        //搜索
        function search() {
            ...
            document.userWorkForm.action = "list";
        ...
        //创建活动
        function createUserWork() {
            document.userWorkForm.action = "create";
            document.userWorkForm.submit();
        }
        //每页显示多少条
                ...
                <div class="tab-content default-tab" id="tab1">
                    <form name="userWorkForm" method="post" action="myList">
                        ...
                        <table width="96%" border="1" cellspacing="0" cellpadding="0" bordercolor="#FFFFFF"
                            ...
                            <g:each in="${userWorkList}" status="i" var="userWork">
                                <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                                    ...
                                    <td align="center"
                                        class="STYLE5">${CTools.cutString(fieldValue(bean: userWork.userActivity, field: 'name'), 16)}</td>
                                    ...
                                    <td align="center">
                                        <a href="${createLink(controller: 'userWork', action: 'edit' , params: [id: userWork.id])}"><img
                                                src="${resource(dir: 'images/skin', file: 'modi.gif')}" alt="编辑" border="0"></a>
                                    </td>
                                    <td align="center">
                                        <a href="javascript: deleteUserWork(${userWork.id});"
                                           onclick="return confirm('确实要删除该活动吗？');"><img
                        ...
                        <div id="progDeal">
                            ...
                            <input class="qqbut" type="button" value="发起" onClick="createUserWork();"/>
                        </div>
