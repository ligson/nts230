...
<g:form id="form1" name="form1" action="metaDefineSave" method="post" onsubmit="return check();">
    ...
    <div class="dialog">
        <table class="table">
            <tbody>
            <tr class="prop">
                <td valign="top" class="directory" style="padding-top:6px;" width="110" align="right">
                    <label>所属元数据标准:</label>
                </td>
                <td class="value ">

                    <input type="radio" style="border:0;" name="allClass" value="1" checked
                           onclick="onAllClass(this.form);">所有元数据标准(包括现有标准和以后添加的标准)<br>
                    <input type="radio" name="allClass" value="0" style="border:0;"
                           onclick="onAllClass(this.form);">部分元数据标准(从下面列表中选择)<br>&nbsp;&nbsp;
            ...
            <tr class="prop">
                ...
                <td class="value ">
                    <select class="form-control" style="width: 200px; float: left" name="elementType"
                            onchange="onIsDeco();">
                    ...
                    <span class="pro_warm">元数据创建后不能修改!</span>
                </td>
            </tr>
            ...
            <tr class="prop">
                ...
                <td class="value ">
                    <input class="form-control" style="width: 200px" type="text" maxlength="100"
                           onchange="checkNameExist(this)" name="name" value="" onblur="checkNameExist(this)"/>
                </td>
            </tr>
            ...
            <tr class="prop">
                ...
                <td class="value ">
                    <input class="form-control" style="width: 200px" type="text" maxlength="40" id="cnName"
                           name="cnName" value=""/>
                </td>
            </tr>
            ...
            <tr class="prop">
                ...
                <td class="value ">
                    <SELECT class="form-control" style="width: 200px" name="dataType" onchange="onChangeData();"
                            id="dataType">
            ...
            <tr class="prop">
                ...
                <td class="value ">
                    <input type="text" class="form-control" style="width: 200px" id="maxLength" name="maxLength"
                           value="0"/>
                </td>
            </tr>
            ...
            <tr class="prop">
                ...
                <td class="value ">
                    <input type="text" class="form-control" style="width: 200px" maxlength="40" id="defaultValue"
            ...
            <tr class="prop">
                ...
                <td class="value ">
                    <input type="text" class="form-control" maxlength="250" id="description" name="description"
                           value=""/>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <div class="buttons">
                        ...
                        <input class="btn btn-primary" type="button" onclick="history.back();" value="取消"/>
                    </div>
                </td>
            </tr>
