    ...
    <div class="statistics_resource_list">
        <div class="statistics_resource_nav">
            ...
            <div class="export_exc">
                <g:if test="${userResourceView(controllerName: 'programMgr',actionName: 'userVisitRanking')=='true'}">
                <a href="${createLink(controller: 'programMgr', action: 'userVisitRanking')}"
        ...
        <div class="statistics_resource_items">
            <div class="statistics_resource_item s_rank" id="resourceView">
                ...
                <div>
                    <g:guiPaginate total="${total}" action="statisticsUserVisit" controller="programMgr"/>
                </div>
            </div>
...
<script type="text/javascript">
    function last_btn() {
        ...
        var appendDiv="";
        if(${userResourceView(controllerName: 'programMgr',actionName: 'userLastloginRanking')=='true'}){
            appendDiv= "<a href='${createLink(controller:'programMgr',action:'userLastloginRanking')}' class='btn btn-success'>导出excel</a>";
        }
    ...
    function view_btn() {
        ...
        var appendDiv="";
        if(${userResourceView(controllerName: 'programMgr',actionName: 'userVisitRanking')=='true'}){
            appendDiv = "<a href='${createLink(controller:'programMgr',action:'userVisitRanking')}' class='btn btn-success'>导出excel</a>";
        }
