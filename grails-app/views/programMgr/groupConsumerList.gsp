...
<form method="post" name="consumerForm">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="biaoge-hui">
        <tr>
            ...
            <td width="30%" class=""><span class="biaoge-hui-br">
                <input name="consumerId" type="text" class="input" onkeypress="getKeyCode()" onfocus="cleard()"
            ...
            <td><table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF">
                ...
                <g:each in="${userGroupConsumerList}" status="i" var="consumer">
                    <tr bgcolor="${(i % 2) == 0 ? '#ffffff' : '#e9e8e7'}">
                        <td height="23" align="center" class="STYLE5">${fieldValue(bean: consumer, field: 'name')}</td>
                        <td align="center" class="STYLE5">${fieldValue(bean: consumer, field: 'nickname')}</td>
                        <td align="center" class="STYLE5">${fieldValue(bean: consumer, field: 'college.name')}</td>
                        <td align="center" class="STYLE5"><g:link action="groupDeleteConsumerOne" id="${consumer.id}"
                ...
                <TABLE width="100%" height="16"
                    ...
                    <TR>
                        ...
                        <TD width="425" align=right><div class="STYLE8">
                            <g:paginate total="${total}" offset="${params.offset}" action="groupConsumerList"
