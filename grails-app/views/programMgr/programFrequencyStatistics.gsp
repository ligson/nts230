...
<head>
    ...
    <script type="text/javascript"
            src="${resource(dir: 'js/boful/programMgr', file: 'programFrequencyStatistics.js')}"></script>
</head>
...
<div class="program_statistics_content">
    ...
    <div class="statistics_math">
        <div id="programFrequencyStatisticsId" class="statistics_math_mark">
    ...
    <div class="statistics_math_tab">
        ...
        <div class=" statitics_cadmin_page">
            <g:guiPaginate action="programFrequencyStatistics" class="all_page" controller="programMgr"
                           total="${total}"/>
        </div>
    </div>
</div>
