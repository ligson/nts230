...
<head>
    ...
    <script type="text/javascript"
            src="${resource(dir: 'js/boful/programMgr', file: 'programRecommendNumStatistics.js')}"></script>
</head>
...
<div class="program_statistics_content">
    ...
    <div class="statistics_math">
        <div id="programRecommendNumStatisticsId" class="statistics_math_mark">
    ...
    <div class="statistics_math_tab">
        <table width="100%">
            ...
            <g:each in="${programList}" var="program" status="i">
                <tr>
                    ...
                    <td align="center">${program.recommendNum}</td>
                </tr>
            </g:each>
            </tbody>
        </table>
        ...
        <div class="statitics_cadmin_page">
            <g:guiPaginate action="programRecommendStatistics" class="all_page" controller="programMgr"
                           total="${total}"/>
        </div>
    </div>
</div>
