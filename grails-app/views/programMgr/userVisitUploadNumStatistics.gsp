...
<head>
    ...
    <script type="text/javascript"
            src="${resource(dir: 'js/boful/programMgr', file: 'userVisitUploadNumStatistics.js')}"></script>
</head>
...
<div class="program_statistics_content">
    ...
    <div class="statistics_title_infor">
        <p>上传统计结果。如下:%{--<a href="#">查看详细</a>--}%</p>
    </div>

    <div class="statistics_math">
        <div id="userVisitUploadNumStatisticsId" class="statistics_math_mark">
    ...
    <div class="statistics_math_tab">
        <table width="100%">
            ...
            <tr>
                ...
                <th width="120" align="center">上传次数</th>
            </tr>
            <g:each in="${consumerList}" status="i" var="consumer">
                <tr>
                    ...
                    <td align="center">${consumer.uploadNum}</td>
                </tr>
            </g:each>
            </tbody>
        </table>
        ...
        <!------------分页------------->
        <div class="">
            <g:guiPaginate action="userVisitUploadNumStatistics" class="all_page" controller="programMgr"
                           total="${total}"/>
        </div>
    </div>
</div>
