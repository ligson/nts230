    ...
    <div align="center">
        ...
        <TABLE cellSpacing=1 cellPadding=0 width="630" bgColor=#999999 border=0>
            ...
            <TR class=table_tr>
                ...
                <TD width="7%" align="left" colspan="3">&nbsp;<input name="searchNNType" type="radio" value="2"
            ...
            <TR class=table_tr>
                <TD height="29" align=middle>&nbsp;学号范围&nbsp;</TD>
                <TD colspan="4" align=left>&nbsp;
                    <input name="numBegin" id="numBegin" type="text" value="">&nbsp;至
                &nbsp;<input name="numEnd" id="numEnd" type="text" value="">
                </TD>
            </TR>
