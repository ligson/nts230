        ...
        <div class="content-box">
            <div class="content-box-header">
                <ul class="content-box-tabs">
                    ...
                    <li><a href="${createLink(controller: 'my', action: 'mySynergicStudyCircle')}" class="default-tab current">我协作的学习圈</a></li>
            ...
            <div class="content-box-content">
                <div class="tab-content default-tab">
                    <form name="form1" method="post" action="/my/mySynergicStudyCircle">
                        ...
                        <table cellpadding="0" cellspacing="0" width="782">
                            ...
                            <g:each in="${studyCircleList}" status="i" var="studyCircle">
                                <tr class="${(i % 2) == 0 ? 'alt-row' : ''}">
                                    ...
                                    <td align="center">
                                        <a href="${createLink(controller: 'my', action: 'cancelCooperation', params: [idList: studyCircle.id])}"
                                           onclick="return confirm('确实要取消协作吗？');"><img src="${resource(dir: 'images/skin', file: 'delete.gif')}"
                                                                                       alt="取消协作" border="0"></a>
                                    </td>
                                    <td align="center">
                                        <a href="${createLink(controller: 'my', action: 'quitStudyCircle', params: [idList: studyCircle.id, type: 1])}"
                        ...
                        <div class="l pt10 pb10">
                            <input class="qqbut" type="button" value="取消协作"
                                   onClick="operate('my', 'cancelCooperation', '');"/>
                        ...
                        <div class="qfy mt5 mb10">
                            <g:if test="${studyCircleList != null && studyCircleList.size() > 0}">
                                <g:paginate controller="my" action="mySynergicStudyCircle" total="${studyCircleTotal}"
