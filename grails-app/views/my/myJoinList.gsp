...
<head>
    ...
    <script type="text/javascript">
        ...
        function search() {
            ...
            document.userActivityForm.action = baseUrl + "my/myJoinList";
            document.userActivityForm.submit();
        }
        //删除活动
        function deleteUserActivity(id) {
            setParams();
            document.userActivityForm.action = baseUrl + "my/deleteJoin?id=" + id;
            document.userActivityForm.submit();
        }
        //批量删除活动
        ...
        <div class="content-box-header">
            <ul class="content-box-tabs">
                ...
                <g:if test="${session.consumer?.role != null && session.consumer?.role != 3}">
                    <li><a href="${createLink(controller: 'my', action: 'myList')}">我发起的活动</a></li>
                </g:if>
