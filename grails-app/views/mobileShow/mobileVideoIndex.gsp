...
%{--<div class="boful_mobile_searchbox ">
    <div class="boful_mobile_search">
         <div class="boful_mobile_logo">
            ...
            <span class="boful_mobile_search_meau" style="cursor: pointer"></span>
            <a href="${createLink(action: 'mobileSearch')}">
            <span class="boful_mobile_search_button" title="搜索"></span></a>
    </div>
</div>--}%
...
<div class="boful_mobile_nav">
    <p id="touchId">
        ...
        <span class="boful_mobile_nav_more" title="更多"><a
                href="${createLink(action: 'mobileSearchMeau', params: [mediaType: '1'])}"></a></span>
    </p>
</div>
<!--头部切换图片-->
<div class="boful_mobile_bananr">
    <div class="boful_image_box">
        <g:each in="${newVideo}" var="program">
            <div class="img1_inner">
                <a class="boful_mobile_bananr1"
                   href="${createLink(action: 'mobileVideoShow', params: [id: program?.id])}">
...
<div class="gridContainer clearfix">
    ...
    <g:each in="${recommendVideoList}" var="program" status="sta">
        <div id="div${sta}" class="fluid boful_mobile_recommend_item">
            <a href="${createLink(action: 'mobileVideoShow', params: [id: program?.id])}" title="${program?.name}">
                <img src="${posterLinkNew(program: program, size: '289x289')}" height="193"
