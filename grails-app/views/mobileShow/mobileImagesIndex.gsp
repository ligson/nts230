...
<div class="boful_mobile_nav">
    <p>
        ...
        <span class="boful_mobile_nav_more"><a
                href="${createLink(action: 'mobileSearchMeau', params: [mediaType: '4'])}"></a></span>
    </p>
</div>
<!--头部切换图片-->
<div class="boful_mobile_bananr">
    <div class="boful_image_box">
        <g:each in="${newImage}" var="program">
            <div class="img1_inner">
                <a class="boful_mobile_bananr1"
                   href="${createLink(action: 'mobileImagesPlay', params: [id: program?.id])}">
...
<div class="gridContainer clearfix">
    <div class="boful_mobile_content_recommend">
        <h1>推荐资源%{--<span class="boful_mobile_content_hot">HOT</span>--}%</h1>
        <a class="boful_mobile_content_more" href="${createLink(action: 'mobileSearch', params: [mediaType: '4'])}"></a>
    </div>
