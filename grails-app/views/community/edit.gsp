...
<head>
    ...
    <SCRIPT type=text/javascript>
        ...
        function returnInfo() {
            document.location.href = baseUrl + "community/show"
        }
    </SCRIPT>
</head>

<body style="background:none;width: 790px;">

<!----首页正文开始---->
<div class="main top" style="width: 780px;">
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <td width="65%"><label for="textfield"></label>
                                    <input type="text" class="inputwitdh" name="name" id="textfield"
                                           value="${studyCommunityInstance.name}"/></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td><label for="textarea"></label>
                                    <textarea name="description" class="inputwitdh" id="textarea" cols="45"
                                              rows="5">${CTools.htmlToBlank(studyCommunityInstance.description)}</textarea></td>
                            </tr>
                            <tr>
                                <td>&nbsp;</td>
                                <td><input type="button" onclick="createCheck()" name="button" class="but" id="button"
                                           value="保存"/>
                                    <input type="button" onclick="returnInfo()" class="but" id="button3" value="返回"/>
                                </td>
                            </tr>
                        </table>
                    </form>
