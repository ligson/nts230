...
(function () {
    ...
    if (strJsPath) {
        ...
        strJsPath = strJsPath.substring(0, index);
        if (strJsPath.indexOf("Anonymous function (") >= 0) {
            strJsPath = strJsPath.replace("Anonymous function (", "");
        }
        return;
    }
    ...
    var index2 = strJsPath.lastIndexOf("/");
    strJsPath = strJsPath.substring(0, index2);
})()
