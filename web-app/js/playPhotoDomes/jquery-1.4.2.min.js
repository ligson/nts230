(function (p, j) {
    ...
    }, oa = p.jQuery, J = p.$, v = p.document, N, K = /^[^<]*(<[\w\W]+>)[^>]*$|^#([\w-]+)$/, M = /^.[^:#\[\.,]*$/, ka = /\S/, $ =
        /^(\s|\u00A0)+|(\s|\u00A0)+$/g, Ya = /^<(\w+)\s*\/?>(?:<\/\1>)?$/, ga = navigator.userAgent, Fa = false, ha = [], aa, pa = Object.prototype.toString, qa = Object.prototype.hasOwnProperty, ra = Array.prototype.push, ia = Array.prototype.slice, Ga = Array.prototype.indexOf;
    ...
    (function () {
        ...
        if (!(!f || !f.length || !l)) {
            c.support = {leadingWhitespace: e.firstChild.nodeType === 3, tbody: !e.getElementsByTagName("tbody").length, htmlSerialize: !!e.getElementsByTagName("link").length, style: /red/.test(l.getAttribute("style")), hrefNormalized: l.getAttribute("href") === "/a", opacity: /^0.55$/.test(l.style.opacity), cssFloat: !!l.style.cssFloat, checkOn: e.getElementsByTagName("input")[0].value === "on", optSelected: v.createElement("select").appendChild(v.createElement("option")).selected,
                parentNode: e.removeChild(e.appendChild(v.createElement("div"))).parentNode === null, deleteExpando: true, checkClone: false, scriptEval: false, noCloneEvent: true, boxModel: null};
    ...
    c.extend({cache: {}, expando: W, noData: {embed: true, object: true,
        applet: true}, data: function (a, b, e) {
    ...
    c.extend({attrFn: {val: true, css: true, html: true, text: true, data: true, width: true, height: true, offset: true}, attr: function (a, b, e, g) {
    ...
    }, global: {}, remove: function (a, b, e, g) {
        if (!(a.nodeType === 3 || a.nodeType === 8)) {
    ...
    c.each({mouseenter: "mouseover", mouseleave: "mouseout"}, function (a, b) {
        c.event.special[a] = {setup: function (e) {
    ...
    if (!c.support.changeBubbles) {
        ...
        c.event.special.change = {filters: {focusout: va, click: function (a) {
            var b = a.target, e = b.type;
            ...
            for (e =
                ...
                if (k === "hover")e.push("mouseenter" + m, "mouseleave" + m); else {
                    ...
                    b === "live" ? B.each(function () {
                        c.event.add(this, L(k, y), {data: g, selector: y, handler: f, origType: k, origHandler: f, preType: r})
                    }) : B.unbind(L(k, y), f)
                }
            }
            return this
    ...
    (function () {
        ...
        var m = function (h, i, n, q) {
            ...
            if (w.length > 1 && y.exec(h))if (w.length === 2 && r.relative[w[0]])A = wa(w[0] + w[1], i); else for (A = r.relative[w[0]] ? [i] : m(w.shift(), i); w.length;) {
                ...
                if (i) {
                    C = q ? {expr: w.pop(), set: F(q)} : m.find(w.pop(), w.length === 1 && (w[0] === "~" || w[0] === "+") && i.parentNode ? i.parentNode : i, ba);
        ...
        {order: ["ID", "NAME", "TAG"], match: {ID: /#((?:[\w\u00c0-\uFFFF-]|\\.)+)/, CLASS: /\.((?:[\w\u00c0-\uFFFF-]|\\.)+)/, NAME: /\[name=['"]*((?:[\w\u00c0-\uFFFF-]|\\.)+)['"]*\]/, ATTR: /\[\s*((?:[\w\u00c0-\uFFFF-]|\\.)+)\s*(?:(\S?=)\s*(['"]*)(.*?)\3|)\s*\]/, TAG: /^((?:[\w\u00c0-\uFFFF\*-]|\\.)+)/, CHILD: /:(only|nth|last|first)-child(?:\((even|odd|[\dn+-]*)\))?/, POS: /:(nth|eq|gt|lt|first|last|even|odd)(?:\((\d*)\))?(?=[^-]|$)/, PSEUDO: /:((?:[\w\u00c0-\uFFFF-]|\\.)+)(?:\((['"]?)((?:\([^\)]+\)|[^\(\)]*)+)\2\))?/}, leftMatch: {},
            attrMap: {"class": "className", "for": "htmlFor"}, attrHandle: {href: function (h) {
            return h.getAttribute("href")
        }}, relative: {"+": function (h, i) {
        ...
        }}, preFilter: {CLASS: function (h, i, n, q, x, w) {
            h = " " + h[1].replace(/\\/g, "") + " ";
            if (w)return h;
            w = 0;
            ...
            return n[3] - 0 === i
        }}, filter: {PSEUDO: function (h, i, n, q) {
    ...
    c.extend({filter: function (a, b, e) {
        if (e)a = ":not(" + a + ")";
    ...
    var Ra = / jQuery\d+="(?:\d+|null)"/g, ma = /^\s+/, Sa = /(<([\w:]+)[^>]*?)\/>/g, ib = /^(?:area|br|col|embed|hr|img|input|link|meta|param)$/i, Ta = /<([\w:]+)/, jb = /<tbody/i, kb = /<|&#?\w+;/, Ca = /<script|<object|<embed|<option|<style/i,
    ...
    c.extend({clean: function (a, b, e, g) {
        b = b || v;
    ...
    var lb = /z-?index|font-?weight|opacity|zoom|line-?height/i, Va = /alpha\([^)]*\)/, Wa = /opacity=([^)]*)/, xa = /float/i, ya = /-([a-z])/ig, mb = /([A-Z])/g, nb = /^-?\d+(?:px)?$/i, ob = /^-?\d/, pb = {position: "absolute", visibility: "hidden", display: "block"}, qb = ["Left", "Right"], rb = ["Top", "Bottom"], sb = v.defaultView && v.defaultView.getComputedStyle, Xa = c.support.cssFloat ? "cssFloat" : "styleFloat", za =
        function (a, b) {
    ...
    var tb = z(), ub = /<script(.|\s)*?\/script>/gi, vb = /select|textarea/i, wb = /color|date|datetime|email|hidden|month|number|password|range|search|tel|text|time|url|week/i, ca = /=\?(&|$)/, Aa = /\?/, xb = /(\?|&)_=.*?(&|$)/, yb = /^(\w+:)?\/\/([^\/?#]+)/, zb = /%20/g, Ab = c.fn.load;
    c.fn.extend({load: function (a, b, e) {
        ...
        var l = this;
        c.ajax({url: a, type: g, dataType: "html", data: b, complete: function (k, s) {
    ...
    c.extend({get: function (a, b, e, g) {
        ...
        global: true, type: "GET", contentType: "application/x-www-form-urlencoded", processData: true, async: true, xhr: p.XMLHttpRequest && (p.location.protocol !== "file:" || !p.ActiveXObject) ? function () {
    ...
    var Ba = {}, Bb = /toggle|show|hide/, Cb = /^([+-]=)?([\d+-.]+)(.*)$/, na, Ea = [
    ...
    c.each({slideDown: T("show", 1), slideUp: T("hide", 1), slideToggle: T("toggle", 1), fadeIn: {opacity: "show"}, fadeOut: {opacity: "hide"}}, function (a, b) {
        c.fn[a] = function (e, g) {
            return this.animate(b, e, g)
        }
    });
    c.extend({speed: function (a, b, e) {
    ...
    c.fn.offset = "getBoundingClientRect"in
        ...
        b = g.body;
        g = g.documentElement;
        return{top: e.top + (self.pageYOffset || c.support.boxModel && g.scrollTop || b.scrollTop) - (g.clientTop || b.clientTop || 0), left: e.left + (self.pageXOffset || c.support.boxModel && g.scrollLeft || b.scrollLeft) - (g.clientLeft || b.clientLeft ||
            0)}
    } : function (a) {
        var b = this[0];
    ...
    c.offset = {initialize: function () {
        ...
        var g = c(a), f = g.offset(), l = parseInt(c.curCSS(a, "top", true), 10) || 0, k = parseInt(c.curCSS(a, "left", true), 10) || 0;
    ...
    c.fn.extend({position: function () {
        ...
        var a = this[0], b = this.offsetParent(), e = this.offset(), g = /^body|html$/i.test(b[0].nodeName) ? {top: 0, left: 0} : b.offset();
...
jQuery.extend(jQuery.easing, {def: "easeOutQuad", swing: function (p, j, u, t, o) {
...
(function (p) {
    p.fn.quicksand = function (j, u, t) {
        var o = {duration: 750, easing: "swing", attribute: "data-id", adjustHeight: "auto", useScaling: true, enhancement: function () {
        }, selector: "> *"};
        p.extend(o, u);
        ...
        return this.each(function (G) {
            ...
            if (p.browser.msie && p.browser.version.substr(0,
                ...
                V.each(function () {
                    ...
                    if (K.length)o.useScaling ? R.push({element: p(this), animation: {top: K.offset().top - v.top, left: K.offset().left - v.left, opacity: 1, scale: "1.0"}}) : R.push({element: p(this), animation: {top: K.offset().top - v.top, left: K.offset().left - v.left, opacity: 1}}); else o.useScaling ? R.push({element: p(this), animation: {opacity: "0.0", scale: "0.0"}}) : R.push({element: p(this), animation: {opacity: "0.0"}})
                });
                S.each(function () {
                    var K = [], M = [];
                    if (typeof o.attribute == "function") {
