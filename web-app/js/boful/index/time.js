...
//     for (var i=yearMin; i<=yearMax; i++) strIframe += "<option value='"+i+"'>"+i+"年</option>";
     ...
     "<table id=tableWeek border=1 width='"+ cal_Width +"' cellpadding=0 cellspacing=0 ";
     ...
     "</td></tr><tr><td valign=top width='"+ cal_Width +"' bgcolor='"+ WebCalendar.lightColor +"'>"+
     "     <table id=tableDay height=120 width='"+ cal_Width +"' border=0 cellspacing=1 cellpadding=0>";
          for(var x=0; x<5; x++){
            strIframe += "<tr>";
            for(var y=0; y<7; y++)
          ...
          "</td></tr></table>"+
     "</td></tr><tr><td height=20 width='"+ cal_Width +"' bgcolor='"+ WebCalendar.lightColor +"'>"+
     "     <table border=0 cellpadding=1 cellspacing=0 width='"+ cal_Width +"'>"+
