...
#############################################################*/
var selects = null;//document.getElementsByTagName('select');
...
window.onload = function(e) {
	//if(typeof(init)=="function" && typeof(showAllTr)=="function" ) init();
	if(typeof(init)=="function") init();

	var uboxstyle = document.getElementById("uboxstyle");
	if(uboxstyle){
		selects = uboxstyle.getElementsByTagName('select')
