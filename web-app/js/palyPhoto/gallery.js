...
//				$items.add('<img src="' + baseUrl+ 'images/playPhoto/ajax-loader.gif"/><img src="' + baseUrl+ 'images/playPhoto/black.png"/>').imagesLoaded( function() {
//					// add options
//					_addViewModes();
//
...
//				});
                ...
                $items.add('<img src="' + baseUrl+ 'images/playPhoto/ajax-loader.gif"/><img src="' + baseUrl+ 'images/playPhoto/black.png"/>');
                _addViewModes();
                _addImageWrapper();
                _showImage( $items.eq( current ) );
			...
			_navigate		= function( dir ) {
                ...
                //根据current获取图片资源的索引获取id，然后根据规则截取相关内容
                var currentImg = $('.es-carousel').find('img').eq(current).attr('id');
                var str1 = currentImg.substring(0, currentImg.lastIndexOf('_'));
                var id = str1.substring(str1.indexOf('_')+1, str1.lastIndexOf('_'));
                var fileHash = str1.substring(str1.lastIndexOf('_') + 1);
                var fileType = currentImg.substring(currentImg.lastIndexOf('_')+1);
