                        ...
                        },
                        {
							...
							onClick : function( evt ){
							  ...
							  // var txtUrlId = txtUrlObj.getInputElement().$.id;
							   ...
							   imgDialog = this.getDialog(); 
							   openFile(2000);
							   //this.getDialog().setValueOf('info','txtUrl',"http://www.baidu.com/img/lm.gif");
                                ...
                                children: [{
                                    ...
                                    commit: function(C, D, E) {
                                        ...
                                        if (C == d) {
                                            ...
                                            else if (!F && this.isChanged()) D.removeStyle('width'); ! E && D.removeAttribute('width');
                                        } else if (C == f) {
                                            var G = F.match(h);
                                            if (!G) {
