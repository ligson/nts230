                                ...
                                if (!a.grid.hDiv.loading) {
                                    ...
                                    if (!1 !== e && "stop" !== e)if (b.isFunction(a.p.datatype))a.p.datatype.call(a, a.p.postData, "load_" + a.p.id, q, c, l); else {
                                        ...
                                        switch (g) {
                                            ...
                                            case "xml":
                                            case "script":
                                                b.ajax(b.extend({url: encodeURI(a.p.url), type: a.p.mtype, dataType: g, data: b.isFunction(a.p.serializeGridData) ? a.p.serializeGridData.call(a, a.p.postData) : a.p.postData,
                    ...
                    if (h !== a.p.savedRow[c].v) {
                        ...
                        if (!0 === s[0]) {
                            ...
                            if ("remote" === a.p.cellsubmit)if (a.p.cellurl) {
                                ...
                                a.grid.hDiv.loading = !0;
                                b.ajax(b.extend({url: encodeURI(a.p.cellurl), data: b.isFunction(a.p.serializeCellData) ? a.p.serializeCellData.call(a, p) : p,
